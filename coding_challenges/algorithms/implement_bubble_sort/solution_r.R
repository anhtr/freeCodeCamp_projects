...
# different approaches. While most modern languages have built-in sorting
...
# comparing adjacent items and swapping them if they are out of order. The
# method continues looping through the array until no swaps occur at which point
# the array is sorted.
#
